...
//                      <button className={`my-button ${activeButton === 1 ? 'active' : ''}`} onClick={() => handleClick(1)}>
//                     Buying
//                     </button>
//                     <button className={`my-button ${activeButton === 2 ? 'active' : ''}`} onClick={() => handleClick(2)}>
//                     Renting
//                    </button>
//                    <button className={`my-button ${activeButton === 3 ? 'active' : ''}`} onClick={() => handleClick(3)}>
//                    Selling
//                   </button>
//                 </div>
//                 <div className="section3_1card">
//                 <div className="section3_card">
//                     <div className="section3_card1">
//                         <Heading headingType={'h3'} headingText={''}/>
//                         <img src="" alt="" />
//                         <p></p>
//                         <a href=""></a>
//                     </div>
